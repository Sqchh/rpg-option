...
but_menu_t *struct_fill_but_menu(void)
{
    ...
    b_menu->but_p = sfTexture_createFromFile("image/b_c_jouer.png", NULL);
    b_menu->but_o = sfTexture_createFromFile("image/b_c_option.png", NULL);
    b_menu->but_t = sfTexture_createFromFile("image/b_c_tutoriel.png", NULL);
    b_menu->but_q = sfTexture_createFromFile("image/b_c_quitter.png", NULL);
    return (b_menu);
}